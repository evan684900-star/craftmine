...
(function () {
  ...
  const GUIDE = [
    ...
    ['🧱 Gravité réaliste (extension)', "À cocher en créant le monde. Le sable, le gravier et la poudre de béton tombent dès qu'il n'y a plus rien dessous. Tes constructions doivent tenir debout : un bloc tient s'il rejoint le sol (ou le terrain naturel) en passant par des blocs solides, sans dépasser dans le vide de plus de 5 blocs pour le bois, 3 pour la pierre et les briques, 7 pour le métal, 2 pour la laine, 1 pour la terre et le verre. Sinon il tombe, et ce qu'il portait aussi : construis des piliers ! Un bloc qui tombe de haut fait mal ; le verre, la glace et les feuilles se brisent. Le terrain naturel reste en place (pas d'éboulement des grottes)."],
