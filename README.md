...
| **Clic droit** | Poser un bloc, ouvrir la table d'enchantement, enfiler une armure, manger (maintenir 1 s), utiliser un outil (écorcer, labourer), semer, nourrir un animal, lancer le grappin, ouvrir un coffre |
...
- Créatures : *Mouflons* (viande, laine, cuir), *Sangliers* (viande, cuir ; ils chargent si on les attaque), *Pingouins* (plumes), *Villageois* (échanges), *Golems de fer* (protecteurs, lingots de fer) et *Ombres* (essence d'ombre).
