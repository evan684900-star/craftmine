...
| **Clic droit** | Poser un bloc, enfiler une armure, manger (maintenir 1 s), utiliser un outil (écorcer, labourer), semer, nourrir un animal, lancer le grappin, ouvrir un coffre |
